        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav">
					<li class="active"><a href="postPac.php"> <span class="glyphicon glyphicon-home"></span> </a></li>
					<li><a href="postPacAvaliacao.php">Avaliação</a></li>
			...
			<div class="row">
				<div class="col-md-3">
					<div class="list-group">
						<a href="postPac.php" class="list-group-item">O que é?</a>
						<a href="#" class="list-group-item active">Como pode ajudar?</a>
						<a href="postPac3.php" class="list-group-item">Qual a duração?</a>
					</div>
				</div>
						
				<div class="col-md-8">
					<!-- Post Content -->
					<p class="lead">Como pode ajudar?</p>
					<p>Para a pessoa com doença respiratória crónica, estes programas aumentam a tolerância ao esforço, diminuem a sensação de falta de ar e o cansaço no dia-a-dia. Desta forma, a pessoa sente-se mais capaz para realizar as suas atividades diárias.</p>
					<p>A participação da família permite esclarecer dúvidas em relação à doença, aprender a prevenir/gerir exacerbações da doença e a melhorar a capacidade de gestão de emoções, como a ansiedade.</p>
					<p>Além disso, durante o programa há a possibilidade de conhecer e partilhar experiências com outros pacientes/famílias a viver o mesmo problema.</p>
				</div>
				<div class="col-md-1">
