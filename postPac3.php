			...
			<div class="row">
				<div class="col-md-3">
					<div class="list-group">
						...
						<a href="#" class="list-group-item active">Qual a duração?</a>
					</div>
				</div>
						
				<div class="col-md-8">
					<!-- Post Content -->
					<p class="lead">Qual a duração?</p>
					<p>Recomenda-se que decorra durante 2 a 3 meses, com uma frequência semanal de 2 a 3 vezes.</p>
				</div>
				<div class="col-md-1">
