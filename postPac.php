			...
			<div class="row">
				<div class="col-md-3">
					<div class="list-group">
						<a href="#" class="list-group-item active">O que é?</a>
						<a href="postPac2.php" class="list-group-item">Como pode ajudar?</a>
				...
				<div class="col-md-8">
					...
					<p>Um programa de reabilitação respiratória integra duas componentes:</p>
					<p>- A componente de exercício físico, dirigida aos pacientes com doença respiratória crónica;</p>
					<p>- A componente de educação e apoio psicossocial, dirigida aos pacientes e família.</p>
					<p>O principal objetivo é reabilitar as pessoas com doença respiratória crónica e ajudar toda a família a lidar melhor com a doença.</p>
					<div class="video">
						<iframe src="https://www.youtube.com/embed/DaQ30Le_ZSw" frameborder="0" allowfullscreen></iframe>
					</div>
				</div>
				<div class="col-md-1">
